...
export interface CornerButtonProps
  ...
  accentColor?: string;
  /** Text colour for the button label. Defaults to white or high-contrast based on accent. */
  textColor?: string;
...
export function CornerButton({
  ...
  const defaultTextColor = textColor ?? (accentColor.toLowerCase() === "#e5ff00" ? "#0008" : "#ffffff");
